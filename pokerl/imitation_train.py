...
def train(cfg: DictConfig, resume_path: str | None = None):
    ...
    # Oracle consulté avant chaque step pour HeuristicExpertReward.
    # start_listening=False : pas de connexion WebSocket, juste la logique locale.
    oracle = SimpleHeuristicsPlayer(
    ...
    eval_best_only_cb = EvalBestOnlyCallback(
        ...
        best_model_path=model_dir / "best_imitation",
        deterministic=True,
